...
function Home() {
    ...
    const [pontos, setPontos] =
        useState<PontoColeta[]>([]);

    const [currentIndex, setCurrentIndex] =
        useState(0);

    const [loadingPontos, setLoadingPontos] =
        useState(true);
    ...
    return (
        ...
        >
                        ...
                        {pontoAtual ? (
                            ...
                            >
                                ...
                                <p
                                    ...
                                    "
                                >
                                    Cadastre um ponto de
                                    coleta para visualizar
            ...
            <button
                ...
                title="Adicionar novo ponto de coleta"
            >
                <svg
                    className="w-8 h-8"
                    fill="none"
