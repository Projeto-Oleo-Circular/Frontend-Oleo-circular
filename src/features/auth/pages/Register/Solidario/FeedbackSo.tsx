                ...
                <main className="flex flex-col w-full md:w-1/2 bg-background overflow-y-auto">
                    <div className="flex-1 flex flex-col px-4 sm:px-6 md:px-8 lg:px-12">
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center pb-4">                            
                            ...
                            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-green-primary mb-2 sm:mb-3 text-center">
                                Cadastro enviado!
                            </h2>
                            
                            <p className="text-sm sm:text-base text-green-primary text-center max-w-sm px-4">
