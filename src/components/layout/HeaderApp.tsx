                ...
                {isMenuOpen && (
                    <div className="absolute right-0 mt-2 w-40 sm:w-48 bg-white rounded-xl shadow-lg border border-white-100 py-1 z-[100] animate-slide-down">
                        <button
                            ...
                            className="w-full flex items-center gap-3 px-4 py-3 text-sm text-white-primary hover:bg-green-50 hover:text-green-primary transition-colors duration-150"
                        >
